          ...
          {painPoints.map((point) => (
            ...
            >
              <div className="relative z-10">
                <div className="mb-6 relative h-16 w-16 transition-transform duration-300 group-hover:scale-110 group-hover:rotate-3">
                  <Image src={point.iconSrc} alt={point.title} fill sizes="64px" className="object-contain" />
                </div>
