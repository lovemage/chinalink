    ...
    return (
      <button
        ...
        onClick={(e) => {
          e.preventDefault()
          e.stopPropagation()
          router.push(`/service-cart?add=${serviceId}`)
        }}
        className={
          isCard
            ...
            : 'mt-4 w-full rounded-full bg-brand-cta px-6 py-3 font-semibold text-white transition-colors hover:bg-brand-cta/90 active:scale-[0.98]'
        }
      >
